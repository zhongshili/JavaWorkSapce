...
function searchRecord() {
	$('#dg_promotion').datagrid({
		...
		success : function(data) {
			$("#dg_promotion").datagrid("loadData", data.rows);
		}
	});
};
...
$("#btn_Add").click(function() {
	url = "/Mall/home/promotion/add";
	$("#dialog_promotion").dialog("open");
...
$("#btn_Edit").click(function() {
	url = "/Mall/home/promotion/update"
	var row = $("#dg_promotion").datagrid("getSelected");
	if (row == null) {
	...
	$("#dialog_promotion").dialog("open");
	$("#id").val(row.id);
	$("#position").combobox('setText',row.position);
...
$("#btn_Del").click(function() {
	url = "/Mall/home/promotion/delete"
	var row = $("#dg_promotion").datagrid("getSelected");
	if (row == null) {
	...
	$.messager.confirm('提示', '确认要删除吗?', function(data) {
		if (data) {
			$.post(url, {
				...
				if (data.success) {
					$("#dialog_promotion").dialog("close");
					$("#dg_promotion").datagrid("reload");
