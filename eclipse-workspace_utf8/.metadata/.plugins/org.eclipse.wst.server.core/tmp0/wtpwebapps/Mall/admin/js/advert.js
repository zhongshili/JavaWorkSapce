...
function searchRecord() {
	$('#dg_advert').datagrid({
		...
		success : function(data) {
			$("#dg_advert").datagrid("loadData", data.rows);
		}
	});
};
...
$("#btn_Add").click(function() {
	url = "/Mall/home/advert/add";
	$("#dialog_advert").dialog("open");
	...
	$.messager.confirm('提示', '确认要删除吗?', function(data) {
		if (data) {
			$.post(url, {
				...
				if (data.success) {
					$("#dialog_advert").dialog("close");
					$("#dg_advert").datagrid("reload");
