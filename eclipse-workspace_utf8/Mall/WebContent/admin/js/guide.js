...
$("#btn_Add").click(function() {
	...
	$("#imgUrl").val("");	//	清楚隐藏的imgUrl值
});

// 单击修改按钮
$("#btn_Edit").click(function() {
	url = "/Mall/guidePage/update"
	var row = $("#dg_guide").datagrid("getSelected");
	if (row == null) {
...
function saveData() {
	var id = $("#id").val();
	var adTitle = $("#adTitle").textbox("getValue");
	var adLeft = $("#adLeft").textbox("getValue");
	var adRight = $("#adRight").textbox("getValue");
...
var uploader = Qiniu.uploader({
	...
	save_key : false, // 为false则以传文件的原名命名，否则随机命名，这里推荐false
	get_new_uptoken:true,	//设置上传文件的时候每次都获取新的token值
	unique_names:false,		//自动生成文件名，如果值为false则保存原文件名
	scope : {
		bucket : key
	},
