...
public class JsonMobile {
	...
	public JsonMobile(String msg, boolean success, List headAdverts, List firstAdverts, List secondAdverts, List seckills, List firstPromotions, List secondPromotions) {
		this.msg = msg;
		this.success = success;
