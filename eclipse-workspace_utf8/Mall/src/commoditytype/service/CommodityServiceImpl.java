...
public class CommodityServiceImpl implements CommodityTypeService {
...
//			自动封装成json数据格式
	...
	public Commodity findOrderInfoById(Commodity oldCommodity) {
		...
		try {
			commodity = commodityDAO.findOrderInfoById(oldCommodity);
	...
	public JsonMsg update(Commodity commodity) {
		...
		CommodityDAOImpl commodityDAO = new CommodityDAOImpl(conn);
		try {
			System.out.println(commodity.getProductPrice());
